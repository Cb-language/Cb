...
Token::Token() : type(TokenType::UNDEFINED_TOKEN), value(""), line(0), column(0), path("")
{
}

Token::Token(const TokenType type, const std::string &value, const size_t line, const size_t column, const std::filesystem::path& path)
