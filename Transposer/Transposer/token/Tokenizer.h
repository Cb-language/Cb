...
private:
	...
	static size_t handleKeywordMatch(const std::string &code, size_t& row, size_t& col, const TokenType tokenType, std::queue<Token>& tokens, const size_t keywordEnd, const std::filesystem::path& path);
