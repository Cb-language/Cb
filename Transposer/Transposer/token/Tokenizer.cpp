...
const std::vector<std::wstring> Tokenizer::capture_blocks = {
    ...
    LR"((?<Keyword>(root|bass|instrument|playerScore|conductorScore|sectionScore|tutti|sordino|section|pause|resume|break|playBar|play|hear|F(?:maj|min)|[A-EG]|song|feat|motif|rest|variation)(?![A-Za-z])))",
    LR"((?<Punctuation>->))",
    LR"((?<UnaryOp>♯|♭|♮))",
    LR"((?<AssignmentOp>\+=|-=|//=|/=|\*=|%=))",
